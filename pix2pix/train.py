...
from dataset.facadesdataloader import Facades
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataPath', default='./dataset/facade_base/train/', help='path to training images')
    ...
    parser.add_argument('--env', type=str, default='pix2pix')
